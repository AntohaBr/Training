...
//
// 🖥 Пример ответа: <Profile userId={4}/>                             <Route path={`friend/:id`} element={<Profile/>}/>
...
// const useAppSelector: TypedUseSelectorHook<RootState> = useSelector
//
// const deleteSome = (id: number) => ({type: 'DELETE', id} as const)
...
//                         Name
//                         {activeColumn?.sortBy === 'name' && (activeColumn.sortDirection === 'asc' ?
//                             <span> &#8593;</span> :
//                             <span> &#8595;</span>)}
//                     </th>
//                     <th style={th} onClick={() => sortHandler('age')}>
//                         Age
//                         {activeColumn?.sortBy === 'age' && (activeColumn.sortDirection === 'asc' ?
//                             <span> &#8593;</span> :
//                             <span> &#8595;</span>)}
//                     </th>
//                 </tr>
...
// 🖥 Пример ответа: sort(a, b)             ОТВЕТ setActiveColumn({sortBy, sortDirection: activeColumn.sortDirection === 'asc' ? 'desc' : 'asc'})
...
// const useAppSelector: TypedUseSelectorHook<RootState> = useSelector
//
// const setUsersAC = (users: UserType[]) => ({type: 'SET-USERS', users} as const )
// type ActionsType = ReturnType<typeof setUsersAC>
//
// // Thunk
...
// В качестве ответа укажите исправленную версию строки.
//
// 🖥 Пример ответа: value={file}                    ОТВЕТ   axios.post('https://neko-back.herokuapp.com/file', formData)
...
//
// 🖥 Пример ответа: iframe.станьНаВесьЭкранПожалуйста()                   ОТВЕТ allowFullScreen={true}
...
//
// 🖥 Пример ответа: value={fileURL}                        ОТВЕТ setFileURL(URL.createObjectURL(maybeFile))
...
// 🖥 Пример ответа: quiz[0]=yes redux=h2    ОТВЕТ  question={<h2 style={quizStyle}>{q.question}</h2>} <h2 style={quizStyle}>{q.answer}</h2>